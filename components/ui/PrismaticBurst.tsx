...
// @ts-ignore - ogl types might be missing or incomplete, suppressing for velocity
...
const PrismaticBurst = ({
  ...
  useEffect(() => {
    ...
    // Cap DPR at 1 to save massive amounts of GPU rendering time on Retina/high-res desktop displays
    const dpr = 1;
  ...
  return <div className="prismatic-burst-container w-full h-full" ref={containerRef} />;
};
